            ...
            <li class="nav-item">
                <a href="javascript:void(0);" class="nav-link">
                    <select name="tapel" id="tapel"
                        style="display:block;width:100%;padding: 3px 20px;text-align:center;background: #ffffff;border:1px solid #333;">
                        <option value="0">Pilih Tapel</option>
                        @php
                        $th = date('Y');
                        for($i = $th-5;$i<$th+5;$i++){ $selected=($i==$th) ? 'selected' : '' ; echo "<option value='"
                            .$i.'_'.($i+1)."' $selected>".$i.'/'.($i+1)."<span class='caret'></span></option>";
                            }
                            @endphp
                ...
                <a href="javascript:void(0);" class="nav-link">
                    <select name="semester" id="semester"
                        ...
                        $genap = ($bulan < 7) ? 'selected' : '' ;
                            ...
                            ; @endphp </select> </a> </li> <li class="nav-item">
            ...
            <li class="nav-item submenu-toggle">
                ...
                <div class="collapse" id="settings-nav">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a href="/dashboard/penilaian/ekskul" class="nav-link">
                                <i class="material-icons">layers</i>
                                Ekstrakurikuler
                            </a>
                        </li>
