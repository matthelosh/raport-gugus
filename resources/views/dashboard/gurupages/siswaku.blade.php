        ...
        <form id="form_create_ortu" action="/ajax/create-ortu" method="POST" class="form-inline">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Orang Tua <span id="namaSiswa"></span></h5>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="alamat_wali" id="alamat_wali" class="form-control" cols="60" rows="4"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                ...
                <div class="modal-footer">
                    <div class="form-group text-center">
                        <button class="btn btn-secondary" data-target=".modal" data-dismiss="modal" >Batal</button>
...
<div class="modal fade" id="modalImportOrtu"  tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="/dashboard/import-ortu" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Import Data Ortu</h5>
                </div>
                <div class="modal-body">
                    @csrf
        ...
        <form class="form form-inline" id="form_update_siswa" action="{{ route('updateonesiswa') }}" method="put" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary dark">
                    ...
                    <h3 class="modal-title text-white">Edit Data <span id="siswaFullName"></span></h3>
                    ...
                    {{-- <div class="row"> --}}
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" id="ortu" name="ortu" title="Ubah melalui menu ortu." disabled>
                            </div>
                        </div>
                        <div class="form-group text-center">
