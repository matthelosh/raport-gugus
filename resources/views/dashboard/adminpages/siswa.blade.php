...
<i   class = "material-icons">people</i>
            ...
            <button class = "btn btn-sm btn-outline btn-danger" data-toggle = "modal" data-target = "#modalAddSiswa" style = "color: #efefef;">
            <i      class = "material-icons">people</i>
                    Siswa Baru
                </button>
...
<div  class = "modal-dialog" role   = "document" style         = "width: 600px;">
<form class = "form form-inline" id = "form_add_siswa" action  = "{{ route('addonesiswa') }}" method = "post" enctype = "multipart/form-data">
            @csrf
            <div    class = "modal-content">
            <div    class = "card">
            <div    class = "card-header card-header-danger">
            ...
            <h3     class = "card-title text-white">Edit Data <span id = "siswaFullName"></span></h3>
                    ...
                    <div class = "card-body">
                        {{-- <div class="row"> --}}
                            ...
                            <div   class = "row">
                            <div   class = "form-group col-sm-6">
                            <label for   = "tempat_lahit" class = "bmd-label-floating">Tempat Lahir</label>
                            ...
                            <div    class = "form-group text-center">
                            <button class = "btn btn-danger  center-block ml-auto mr-auto" data-dismiss = "modal">
                            <i      class = "material-icons">close</i>
                                    Batal
                                </button>
                                <button class = "btn btn-primary  center-block ml-auto mr-auto" type = "submit" id = "btn-submit-add-siswa">
